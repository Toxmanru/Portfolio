      ...
      <div className="relative min-h-screen pb-20 pt-[64px] md:pt-[104px] z-10">
        <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16 h-[calc(100vh-184px)]">
          ...
          <div className="mt-4 md:mt-8 h-[calc(100%-104px)]">
            {/* Основная секция */}
            <div className="w-full rounded-[24px] md:rounded-[48px] flex flex-col justify-between p-6 md:p-10 text-[#1C1C1C] card left-card h-full text-center md:text-left" style={{ backgroundColor: 'rgba(221, 221, 221, 0.6)' }}>
